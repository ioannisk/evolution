...
# python interactive-eval.py 1rfolds3/model1 ~/data/glove/glove-840B.npy --vocab ~/data/glove/glove-840B-vocabulary.txt -i -a
...
####### TO BE DONE THIS ONE FOLD 0 STILL NOT TRAINED #######
