...
# python -u my_train.py ~/data/glove/glove.840B.300d.txt /home/ioannis/evolution/data/training_pairs_300.json /home/ioannis/evolution/data/validation_pairs_300.json my_model mlp --lower -e 30 -u 300 -d 0.8  -b 32 -r 0.005 --optim adagrad
