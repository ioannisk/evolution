...
plt.bar(xx, bar_nb_data, width=0.2, color='b', linewidth=3,  label='Naive Bayes')
plt.bar(xx+0.2, bar_cbow_data, width=0.2, color='orange', linewidth=3,  label='CBOW Cosine Sim')
plt.bar(xx+0.4, bar_tf_data, width=0.2, color='g', linewidth=3,  label='Tf-idf Cosine Sim')
plt.bar(xx+0.6, np.mean(bar_avrg,0), width=0.2, color='r', linewidth=3,  label='Decomposable Attention',yerr=np.std(bar_avrg,0),ecolor='black')
