...
with open("/home/ioannis/models/best_eda/model1/prob_predictions_filter.txt", "r") as file_:
    predictions = []
    for line in file_:
        line = line.strip()
        predictions.append(float(line))
data = []
with open("/home/ioannis/data/recovery_test/fold1/ranking_validation.json.filter", "r") as file_:
    counter = 1
    for line in file_:
        line = json.loads(line.strip())
        data.append(line)
valid_subset = open("/home/ioannis/data/recovery_test/fold1/ranking_validation.json_valid", 'w')
valid_subset_pred = open("/home/ioannis/models/best_eda/model1/prob_predictions_valid.txt", 'w')

testing_subset = open("/home/ioannis/data/recovery_test/fold1/ranking_validation.json_test", 'w')
testing_subset_pred = open("/home/ioannis/models/best_eda/model1/prob_predictions_test.txt", 'w')
